...
export { bindComponentProps, dispatchAction } from './core/use-component.svelte.js';
export { fromSignal } from './core/signal-bridge.svelte.js';
export type { BoundProperty, ComponentEntry, ComponentRegistry } from './core/types.js';
